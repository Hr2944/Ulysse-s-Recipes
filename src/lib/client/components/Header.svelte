		...
		<div class="flex-grow">
			<form action="/search" class="relative mx-auto max-w-lg transition-all duration-300" method="GET">
				<div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
					<svg class="h-6 w-6 fill-on-surface/50 transition-colors duration-300" class:fill-secondary={focused}
				...
				<input
                 ...
                 placeholder:text-on-surface/50 focus:border-secondary focus:bg-white focus:outline-none focus:ring-0 hover:shadow-inner"
					name="q"
