...
<header
	...
	>
		...
		<a class="flex items-center gap-2 transition-transform duration-300 hover:-translate-y-0.5" href="/">
			<enhanced:img alt="Logo" class="aspect-square w-12 h-12 object-contain" src="/src/lib/assets/logo.png"></enhanced:img>
			<span
		...
		<div class="flex-grow">
			<form action="/search" class="relative mx-auto max-w-lg transition-all duration-300" method="GET">
				<div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
					<svg class="h-6 w-6 fill-on-surface/50 transition-colors duration-300" class:fill-primary={focused}
