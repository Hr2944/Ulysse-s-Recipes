...
>
	<div class="relative aspect-[4/3] w-full overflow-hidden">
		...
		<div class="absolute top-4 right-4 flex gap-2">
			{#if recipe.is_vegan}
				<div class="rounded-full bg-white/95 px-2 py-1 text-primary shadow-sm backdrop-blur-md border border-primary/10" title="Végan">
			...
			{:else if recipe.is_vegetarian}
				<div class="rounded-full bg-white/95 px-2 py-1 text-primary shadow-sm backdrop-blur-md border border-primary/10" title="Végétarien">
	...
	<div class="flex flex-grow flex-col p-6">
		...
		<div class="mt-6 flex items-center justify-between border-t border-primary/10 pt-4 text-sm font-medium text-on-surface/60">
			...
			{#if recipe.average_rating > 0}
				<div class="flex items-center gap-1 rounded-full bg-yellow-100/50 px-2 py-0.5 text-yellow-700 font-bold" title="Note moyenne">
