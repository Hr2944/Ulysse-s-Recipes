...
<div class="group relative">
	<input bind:value={value}
				 class="peer w-full rounded-t-lg border-b-2 border-on-surface/30 bg-black/5 px-4 pb-2 pt-6 text-base text-on-surface transition placeholder:text-transparent focus:border-primart focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-200"
