    ...
    <div class="flex h-full flex-col px-6">
     <div class="sticky top-0 pt-6 bg-surface z-10">
      <div class="flex items-center justify-between pb-4">
       ...
       <button onclick={() => (isIngredientsSheetOpen = false)} class="text-on-surface/80 hover:bg-on-surface/20 rounded-full p-1 transition-colors">
     ...
     <div class="flex items-center justify-center gap-4 rounded-full bg-white border border-primary/10 p-1.5 shadow-sm mx-auto w-10/12 max-w-xs">
      <button onclick={() => updateServings(servings - 1)} disabled={servings <= 1} class="rounded-full bg-primary/5 p-3 text-primary hover:bg-primary hover:text-white transition-colors disabled:opacity-50">
       <svg height="20" viewBox="0 -960 960 960" width="20" fill="currentColor"><path d="M200-440v-80h560v80H200Z" /></svg>
      </button>
      ...
      <button onclick={() => updateServings(servings + 1)} class="rounded-full bg-primary/5 p-3 text-primary hover:bg-primary hover:text-white transition-colors">
       <svg height="20" viewBox="0 -960 960 960" width="20" fill="currentColor"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" /></svg>
      </button>
     </div>
